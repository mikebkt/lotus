...
var verify = require('./11.verifyXml_tool');
var verifyStringOnly = require('./9.2.18.xmlVerify-200');
...
const resource = "/api/xml/sign/defaultdata";
...
const req = http.request(options, res => {
  ...
  res.on('end', () => {
    verify(chunk.toString());
    fs.writeFileSync("signed.txt", JSON.parse(chunk.toString()).base64xmlsigned); 
    verifyStringOnly(chunk.toString())
