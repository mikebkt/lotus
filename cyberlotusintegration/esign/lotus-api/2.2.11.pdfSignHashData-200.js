...
const base64pdf =  fs.readFileSync("./testfile/CL_Integration.pdf");

const base64hash = crypto.createHash('sha256').update(base64pdf).digest('base64');
const base64hash2 = crypto.createHash('sha256').update(base64pdf).digest('hex')
console.log("base64hash :", base64hash);
console.log("base64hash2 :", base64hash2);
